package com.yinrong.mns.tools.util;

import java.util.List;
import java.util.Map;

import cn.vfinance.open.tool.VfinOpenConstants;

import com.fasterxml.jackson.core.type.TypeReference;

public class HttpInvokeUtil {
	
	private static final String CHARSET = VfinOpenConstants.CHARSET_UTF8;
	...
	public static final String ERROR_RESPONSE = VfinOpenConstants.OP_ERROR_BODY;
	...
	public static Object callUploadAsObject(String url, Map<String, String> params,Map<String, FileItem> fileParams, Class<?> cls) throws RuntimeException {
		...
		if (respMap.get(ERROR_RESPONSE) == null) {
			String object = respMap.get(params.get(VfinOpenConstants.METHOD).replaceAll("\\.", "_")+"_response")==null?"":JsonUtil.buildNormalBinder().toJson(respMap.get(params.get(VfinOpenConstants.METHOD).replaceAll("\\.", "_")+"_response"));
