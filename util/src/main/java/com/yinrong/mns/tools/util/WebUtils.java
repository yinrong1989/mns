...
import com.yinrong.mns.tools.VfinOpenConstants;
...
public abstract class WebUtils {
	...
	private static final String DEFAULT_CHARSET = VfinOpenConstants.CHARSET_UTF8;
	...
	public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset,
		...
		if (StringUtils.isBlank(charset))
			charset = VfinOpenConstants.CHARSET_UTF8;
		if (fileParams == null || fileParams.isEmpty()) {
